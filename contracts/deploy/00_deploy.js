...
module.exports = async ({ deployments }) => {
  ...
  //     {
  //       from: wallet.address,
  //       args: [TAS.address, SplitterFactory.address, SchemaRegistry.address,TablelandSubscriptions.address],
  //       log: true,
  //     }
  //   );
  
  //   const TablelandSubscriptionsIndexer = await hre.ethers.getContractFactory("TablelandSubscriptionsIndexer")
  //   const TablelandSubscriptionsContractInstance = TablelandSubscriptionsIndexer.attach(TablelandSubscriptions.address);
  
  //   let makeRegistryOwner = await TablelandSubscriptionsContractInstance.transferOwnership(ContentSubscriptionResolver.address)
  //   await makeRegistryOwner.wait()
